...
import 'package:learn_english/view/play_game/features/slide_party/features/app_setting/app_setting_controller.dart';
...
import 'package:learn_english/view/play_game/features/slide_party/features/playboard/models/skill_keyboard_state.dart';
...
class SkillKeyboard extends HookConsumerWidget {
  ...
  String get skillButtonText =>
      keyboard.activeSkillKey.keyLabel == ' ' ? 'Space Key' : keyboard.activeSkillKey.keyLabel + ' Key';
  ...
  Widget _actionIcon(
    ...
    final color = isDisabled ? Theme.of(context).disabledColor : Theme.of(context).colorScheme.onPrimary;
    switch (actions) {
  ...
  Color _cardColor(
    ...
    if (openSkill.show) {
      if (openSkill.queuedAction == null) {
        ...
        if (otherPlayersColors != null && otherPlayersColors!.length >= index + 1) {
          return otherPlayersColors![index].primaryColor;
        }
        if (otherPlayersIds != null && otherPlayersIds!.length >= index + 1) {
          return ButtonColors.values[int.parse(otherPlayersIds![index])].primaryColor;
        }
        return Theme.of(context).colorScheme.surface;
      }
    } else {
          ...
          child: Center(
            child: AnimatedCrossFade(
              ...
              firstChild: _actionIcon(
                ...
                openSkill.usedActions[SlidepartyActions.values[cardIndex]] == true,
              ),
              secondChild: Text(
                otherPlayersIds!.length > cardIndex ? otherPlayersIds![cardIndex] : '',
                style: Theme.of(context).textTheme.bodyText2!.copyWith(
        ...
        child: Card(
          ...
          child: Center(
            child: AnimatedCrossFade(
              ...
              secondChild: Text(
                otherPlayersColors!.length > cardIndex ? otherPlayersColors![cardIndex].name[0].toString() : '',
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final skillBar = SizedBox(
      ...
      child: AnimatedOpacity(
        ...
        child: Row(
          children: [
            for (int cardIndex = 0; cardIndex < 3; cardIndex++) _buildOpponentSelect(context, cardIndex, openSkill),
          ],
        ),
      ),
    );
            ...
            Expanded(
              child: Row(
                children: List.generate(
                  3,
                  (index) => index == 1 ? _buildKey(context, keyboard.control.up) : const Expanded(child: SizedBox()),
                ),
              ),
            ),
            Expanded(
  ...
  TweenAnimationBuilder<double> _animateSkillBar(SkillKeyboardState openSkill, SizedBox skillBar) {
              ...
              children: [
                Center(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .caption!
                      .copyWith(color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.6)),
                )),
                Center(
                  child: Text(
                    skillButtonText,
