...
class SkillKeyboardState with _$SkillKeyboardState {
  const factory SkillKeyboardState.inGame({
    ...
    @Default(<SlidepartyActions, bool>{}) Map<SlidepartyActions, bool> usedActions,
  ...
  factory SkillKeyboardState.fromJson(Map<String, dynamic> json) => _$SkillKeyboardStateFromJson(json);
}

extension ExistCheckExt on Map<SlidepartyActions, bool> {
  bool isExist(SlidepartyActions? action) => action == null ? false : (this[action] ?? false);
}
