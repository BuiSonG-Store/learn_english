...
import 'package:learn_english/view/play_game/features/slide_party/features/playboard/models/playboard_state/single_playboard_state.dart';
...
class MultiplePlayboardState extends PlayboardState {
  ...
  List<String> getPlayerIds(String playerId) => _playerStates.keys.toList()..remove(playerId);
  ...
  MultiplePlayboardState setConfig(String index, PlayboardConfig _config) => MultiplePlayboardState(
        boardSize: boardSize,
        playerCount: playerCount,
        usedActions: _usedActions,
        playerStates: _playerStates,
        stateConfig: (config as MultiplePlayboardConfig).changeConfig(index, _config),
      );
